      ...
      <div className="mt-52 mb-32">
        <div className="">
          <div className="lg:flex gap-40">
            <div className="mb-12 md:ml-20 md:max-w-md lg:ml-0 lg:max-w-md lg:mb-32 xl:ml-0 xl:max-w-xl">
              ...
              <p className="mt-4 text-xl">
                ...
                desire, before coming into the world to be held by hands and
                touched by lips. These things are images of my own soul. To me,
                the act of making is physical poetry, guided by hands and heart
          ...
          <p className="md:ml-20 md:max-w-md lg:max-w-xl lg:mt-60 text-lg">
            ...
            including the use of materials, processes and influences. My main
            inspiration is the natural world and I want to work in ways that
            ...
            on the subject; please email me at …
          </p>
        </div>
      </div>
    </motion.div>
